...
export const Cart = () => {
 ...
 const handleSaveBilling = (e) => {
  ...
  (
    ...
    Number(totalPrice.shipping_charges));
                        ...
                        <Table responsive>
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <b>{formatPrice((Number(totalPrice.total_selling_price) - appliedDiscount) + Number(totalPrice.total_add_on_charges) + Number(totalPrice.custom_fit_charges) + Number(totalPrice.stiching_charges) + Number(totalPrice.shipping_charges))}</b>
                              </td>
                            </tr>
                        ...
                        <Table responsive>
                          <tbody>
                            ...
                            <tr className="dweoihrwerwer aiksndjhugwerwerw mb-3">
                              ...
                              <td>
                                <span><b>{formatPrice((Number(totalPrice.total_selling_price) - appliedDiscount) + Number(totalPrice.total_add_on_charges) + Number(totalPrice.custom_fit_charges) + Number(totalPrice.stiching_charges) + Number(totalPrice.shipping_charges))}</b></span>
                              </td>
                            </tr>
