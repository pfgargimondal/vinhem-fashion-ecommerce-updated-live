                    ...
                    <div className="diwenjrbwebrwehgrwer mt-5">
                      ...
                      <div className="dopwejoirjhwer row">
                        <div className="col-lg-4">
                          <button className="btn w-100 btn-transparent" onClick={() => setChatProfileDetailsShow(true)}>
                            <i class="bi me-1 bi-chat-left-text"></i> Chat Now
                          </button>
                        </div>

                        <div className="col-lg-4">
                          <button className="btn w-100 btn-main" onClick={() => (window.location.href = "tel:7003672926")}>
                ...
                <div className="col-lg-3 mt-5">
                  <div className="odnwejihrwerwer sticky-top mt-5">
                    <div className="dowehjkrhweirwer mb-5">
                      ...
                      <div className="coisdefisdhifhsdjifjhosd doiwejrjwejr" style={{ height: '100vh' }}>
                        <Swiper
                          modules={[Autoplay, Pagination, Navigation, Mousewheel]}
                          direction="vertical"
                          slidesPerView={4}
